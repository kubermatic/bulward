...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1.Project":             schema_pkg_apis_apiserver_v1alpha1_Project(ref),
		"github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1.ProjectList":         schema_pkg_apis_apiserver_v1alpha1_ProjectList(ref),
		"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.ObjectReference":       schema_pkg_apis_storage_v1alpha1_ObjectReference(ref),
		"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.Organization":          schema_pkg_apis_storage_v1alpha1_Organization(ref),
		"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationCondition": schema_pkg_apis_storage_v1alpha1_OrganizationCondition(ref),
		"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationList":      schema_pkg_apis_storage_v1alpha1_OrganizationList(ref),
...
func schema_pkg_apis_apiserver_v1alpha1_Organization(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationSpec", "github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_apiserver_v1alpha1_ProjectList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1.Project"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1.Project", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_storage_v1alpha1_OrganizationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.Organization"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.Organization", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
...
func schema_pkg_apis_storage_v1alpha1_OrganizationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					"metadata": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationMetadata"),
						},
					},
					"owners": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationMetadata", "k8s.io/api/rbac/v1.Subject"},
	}
}
					...
					"conditions": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1.OrganizationCondition"),
									},
								},
							},
						},
