...
goimports -local github.com/kubermatic/bulward -w .
...
$PROTOBUF_GEN \
  -h ${HEADER_FILE} \
  --packages github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1,github.com/kubermatic/bulward/pkg/apis/storage/v1alpha1 \
