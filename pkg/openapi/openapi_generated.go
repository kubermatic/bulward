...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplate":          schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplate(ref),
		"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateCondition": schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateCondition(ref),
		"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateList":      schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateList(ref),
...
func schema_pkg_apis_apiserver_v1alpha1_Organization(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_pkg_apis_apiserver_v1alpha1_OrganizationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/apiserver/v1alpha1.Organization"),
									},
								},
							},
						},
...
func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplate(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplate is internal representation for OrganizationRoleTemplate in Bulward.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateSpec", "github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateCondition(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplateCondition contains details for the current condition of this OrganizationRoleTemplate.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"type": {
						SchemaProps: spec.SchemaProps{
							Description: "Type is the type of the OrganizationRoleTemplate condition, currently ('Ready').",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplateList contains a list of OrganizationRoleTemplate.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplate"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplate", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateMetadata(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplateMetadata contains the metadata of the OrganizationRoleTemplate.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"displayName": {
						SchemaProps: spec.SchemaProps{
					...
					"description": {
						SchemaProps: spec.SchemaProps{
							Description: "Description is the long and detailed description of the OrganizationRoleTemplate.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplateSpec describes the desired state of OrganizationRoleTemplate.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"metadata": {
						SchemaProps: spec.SchemaProps{
							Description: "Metadata\tcontains additional human readable OrganizationRoleTemplate details.",
							Ref:         ref("github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateMetadata"),
						},
					},
					"scopes": {
						SchemaProps: spec.SchemaProps{
					...
					"bindTo": {
						SchemaProps: spec.SchemaProps{
							Description: "BindTo defines the member types of the Organization that this OrganizationRoleTemplate will be bound to.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
				...
				Required: []string{"scopes", "rules"},
			},
		},
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateMetadata", "k8s.io/api/rbac/v1.PolicyRule"},
	}
}

func schema_pkg_apis_core_v1alpha1_OrganizationRoleTemplateStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "OrganizationRoleTemplateStatus represents the observed state of OrganizationRoleTemplate.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"observedGeneration": {
						SchemaProps: spec.SchemaProps{
							Description: "ObservedGeneration is the most recent generation observed for this OrganizationRoleTemplate by the controller.",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
					"conditions": {
						SchemaProps: spec.SchemaProps{
							Description: "Conditions represents the latest available observations of a OrganizationRoleTemplate's current state.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationRoleTemplateCondition"),
									},
								},
							},
						},
...
func schema_pkg_apis_core_v1alpha1_OrganizationSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"owners": {
						SchemaProps: spec.SchemaProps{
							Description: "Owners holds the RBAC subjects that represent the owners of this organization.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/kubermatic/bulward/pkg/apis/core/v1alpha1.OrganizationMetadata", "k8s.io/api/rbac/v1.Subject"},
	}
}
